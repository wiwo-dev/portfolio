...
export default function AboutMeSection() {
  ...
  return (
    <>
      ...
      <section className="bg-yellow-base ">
        <div className="mx-auto max-w-screen-2xl px-[32px] relative py-10">
        ...
        {windowWidth < 1024 && (
          <motion.div
            ...
            id="STAMPS REF"
            className="bg-yellow-base p-5 sticky bottom-0 flex flex-nowrap justify-center items-center overflow-hidden mt-[0vh] h-[200px] relative"></motion.div>
        )}
      </section>
    </>
  );
