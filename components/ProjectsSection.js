    ...
    <section className="min-h-screen bg-yellow ">
      <div className="max-w-7xl mx-auto p-2 lg:p-7">
        ...
        <div ref={ref} className="flex flex-row-reverse gap-5">
          <motion.div style={{ x: x2 }} className="lg:w-1/2">
            <ProjectCard />
          </motion.div>
          <motion.div
            className="border-[8px] rounded-tl-[80px] rounded-br-[80px] rounded-tr-[20px] rounded-bl-[20px] border-black bg-white flex justify-center items-center lg:w-1/2"
...
function ProjectCard() {
  return (
    <div className="min-h-[200px] border-[8px] rounded-tr-[80px] rounded-bl-[80px] rounded-tl-[20px] rounded-br-[20px] border-black bg-violet flex flex-col text-left gap-5 text-white p-10">
      <p className="font-extrabold text-base lg:text-xl">Game in react</p>
